...
export const SparkleAround = ({ className = '' }) => {
  return (
    <div
      className={`pointer-events-none absolute z-20 h-full w-full ${className}`}
    >
      <SparkleInterface size='1em' top={34} left={14} delay={0.5} />
      <SparkleInterface size='1.8em' top={12} left={68} delay={0.1} />
      <SparkleInterface size='0.7em' top={54} left={80} delay={0.4} />
      <SparkleInterface size='1.2em' top={74} left={4} delay={0} />
    </div>
  );
};
